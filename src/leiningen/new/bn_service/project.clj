(defproject {{name}} "0.1.0-SNAPSHOT"
  ...
  :repositories [["snapshots" {:url "https://nexus.brightnorth.co.uk/content/repositories/snapshots" :password :env :username :env}]
                 ["releases" {:url "https://nexus.brightnorth.co.uk/content/repositories/releases" :password :env :username :env}]])
